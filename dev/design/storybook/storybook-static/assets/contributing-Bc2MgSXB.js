import{j as t,M as a}from"./iframe-_cKE9r89.js";import{useMDXComponents as s}from"./index-BsQHpXCm.js";import"./preload-helper-D6kgxu3v.js";const r=`# Contribute to Strapi Design System
...
`;function o(e){const{Markdown:n}={...s(),...e.components};return n||i("Markdown"),t.jsxs(t.Fragment,{children:[t.jsx(a,{title:"Getting Started/Contributing"}),`
`,t.jsx(n,{children:r})]})}function d(e={}){const{wrapper:n}={...s(),...e.components};return n?t.jsx(n,{...e,children:t.jsx(o,{...e})}):o(e)}function i(e,n){throw new Error("Expected component `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{d as default};
