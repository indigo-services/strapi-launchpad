import{j as t,M as a}from"./iframe-_cKE9r89.js";import{useMDXComponents as c}from"./index-BsQHpXCm.js";import"./preload-helper-D6kgxu3v.js";const h=`# @strapi/ui-primitives
...
## 2.0.0-beta.0
`;function n(s){const i={a:"a",p:"p",...c(),...s.components},{Markdown:e}=i;return e||m("Markdown"),t.jsxs(t.Fragment,{children:[t.jsx(a,{title:"Getting Started/Changelog/Primitives"}),`
`,t.jsxs(i.p,{children:["This is autogenerated by ",t.jsx(i.a,{href:"https://github.com/changesets/changesets",rel:"nofollow",children:"Changesets"})]}),`
`,t.jsx("div",{style:{paddingBottom:20}}),`
`,t.jsx(e,{children:h})]})}function p(s={}){const{wrapper:i}={...c(),...s.components};return i?t.jsx(i,{...s,children:t.jsx(n,{...s})}):n(s)}function m(s,i){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}export{p as default};
