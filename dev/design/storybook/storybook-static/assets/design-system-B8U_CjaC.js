import{j as t,M as n}from"./iframe-_cKE9r89.js";import{useMDXComponents as c}from"./index-BsQHpXCm.js";import"./preload-helper-D6kgxu3v.js";const o=`# @strapi/design-system
...
`;function a(s){const e={a:"a",p:"p",...c(),...s.components},{Markdown:i}=e;return i||h("Markdown"),t.jsxs(t.Fragment,{children:[t.jsx(n,{title:"Getting Started/Changelog/Design System"}),`
`,t.jsxs(e.p,{children:["This is autogenerated by ",t.jsx(e.a,{href:"https://github.com/changesets/changesets",rel:"nofollow",children:"Changesets"})]}),`
`,t.jsx("div",{style:{paddingBottom:20}}),`
`,t.jsx(i,{children:o})]})}function b(s={}){const{wrapper:e}={...c(),...s.components};return e?t.jsx(e,{...s,children:t.jsx(a,{...s})}):a(s)}function h(s,e){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}export{b as default};
